#!/bin/bash
CUDA_VISIBLE_DEVICES=2 python3 ./train_model_qlora.py --model_name "meta-llama/Meta-Llama-3.1-8B-Instruct" --output_dir './output' --training_dataset './data/training_data/DFINAL_VTrain.csv' --test_dataset './data/training_data/DFINAL_VTest.csv' --hf_model_name 'llama-3.1-8B-Instruct-v1.6-only-full-precision-lora_v3' --steps '700' --model_adapter ''

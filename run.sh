#!/bin/bash
CUDA_VISIBLE_DEVICES=2 python3 ./train_model_qlora.py --model_name "meta-llama/Meta-Llama-3.1-8B-Instruct" --output_dir './output' --training_dataset './data/training_data/warm-up_400samples.csv' --test_dataset './data/training_data/warm-up_400samples.csv' --hf_model_name 'llama-3.1-8B-Instruct-only-warmup' --steps '100' --model_adapter ''
